...
last_screenwidth=%A_ScreenWidth%
...
;------------------------------------------------------------------------------
;    SendInput, #gr
    Runwait, taskkill /im GridMove.exe /f
...
;Tray icons cleanup code taken from:
;http://techforpassion.blogspot.com/2014/04/refresh-tray-icons-how-to-remove-dead-tray-icons-after-killing-program.html
tray_icons()
{
